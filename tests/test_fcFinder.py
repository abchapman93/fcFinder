...
class MarkupConditionssTest(unittest.TestCase):
    def setUp(self):
        ...
        self.first_classifier = rules.markup_conditions(markup=self.first_markup)
        self.second_classifier = rules.markup_conditions(markup=self.second_markup)
        self.third_classifier = rules.markup_conditions(markup=self.third_markup)
        self.classifier = rules.markup_conditions(markup=self.empty_markup)
    ...
    def test_first_sentence_has_target(self):
        ...
        classifier = rules.markup_conditions(markup)
    ...
    def test_all_attributes_in_irrelevant_markup_are_false(self):
        ...
        i_classifier = rules.markup_conditions(markup=i_markup)
    ...
    def test_first_sentence_markup_class_is_positive(self):
        self.assertEqual(rules.markup_classifier(self.first_classifier),"Fluid collection-positive")
    def test_second_sentence_markup_class_is_negated(self):
        self.assertEqual(rules.markup_classifier(self.second_classifier),"Fluid collection-negated")
    def test_third_sentence_markup_class_is_indication(self):
        self.assertEqual(rules.markup_classifier(self.third_classifier),"fluid collection-indication")
    ...
    def test_indication_with_pseudoanatomy_has_pseudoanatomy(self):
        ...
        pseudo_conditions = rules.markup_conditions(markup=pseudo_markup)
    ...
    def test_indication_with_pseudo_anatomy_is_none(self): #this pseudo rule is not working
        ...
        pseudo_markup = fc.markup_sentence(pseudo_sentence)
        pseudo_conditions = rules.markup_conditions(markup=pseudo_markup)
        self.assertIsNone(rules.markup_classifier(pseudo_conditions))
   #def test_
